...
class Contractsec extends Model
{
     ...
     * @var array
     */
    protected $fillable = ["m_NAME", "name_b", "type", "begin_date", "end_date", "bank_name", "bank_branch", "bank_account", "salary", "office_tel", "home_tel", "mobile_tel", "creator"];
